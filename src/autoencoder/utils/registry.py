"""Sauvegarde / chargement des autoencodeurs entraînés.
...
indéchiffrable — stockés dans un seul .npz sous src/autoencoder/models/.

Même format que les registres K-means, Kohonen et PCA : chaque algo garde le
sien, c'est ce qui empêche les modèles de se mélanger entre algos.
"""
